...
//             if (product) {
//               const itemCopy = { ...product, size, quantity: cartitems[itemId][size] };
...
//         default:
//           toast.warn('Selected payment method is not yet implemented.');
//           break;
//       }
//     } catch (error) {
...
//             <button
//               type="submit"
//               className="bg-black text-white px-15 text-sm py-2"
//             >
//               PLACE ORDER
//             </button>
//           </div>
