...
const PlaceOrder = () => {
  ...
  const{navigate}=useContext(abcContext)
  return (
  
      <div className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t mx-25">
        {/* ----------left side-------- */}
        ...
        <div className='mt-8'>
          ...
          <div className='mt-12'>
            ...
            <div className='w-full text-end mt-8'>
              <button onClick={()=>navigate('/orders')}className='bg-black text-white px-16 text-sm'>PLACE ORDER</button>
            </div>
          </div>
        </div>
    </div>
